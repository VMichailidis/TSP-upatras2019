# distance matrix
dm = (( 0,86,49,57,31,69,50),(86, 0,68,79,93,24, 5),(49,68, 0,16, 7,72,67),(57,79,16, 0,90,69, 1),(31,93, 7,90, 0,86,59),(69,24,72,69,86, 0,81),(50, 5,67, 1,59,81, 0))
...
for k in V:
    ...
    print(sum(x[k,j] for j in V if j !=k ))
    sum( x[i,k] for i in V if i!=k ) == 1
    print(sum(x[k,i] for i in V if i!=k))
